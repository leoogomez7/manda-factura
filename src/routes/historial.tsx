                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-end gap-1">
                        <IconBtn title="Descargar PDF" onClick={() => downloadInvoicePdf(i)}>
                          <Download className="h-4 w-4" />
                        </IconBtn>
                        <IconBtn title="Imprimir" onClick={() => printInvoicePdf(i)}>
            ...
            {filtered.map((i) => (
              <div key={i.id} className="p-4">
                ...
                <div className="mt-3 flex gap-2">
                  <Button size="sm" variant="secondary" type="button" onClick={() => downloadInvoicePdf(i)}>
                    <Download className="mr-1 h-3.5 w-3.5" /> PDF
                  </Button>
                  <Button size="sm" variant="ghost" onClick={() => printInvoicePdf(i)}>
